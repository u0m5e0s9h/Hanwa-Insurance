...
import { Phone, Mail, Home, Search, Menu, ChevronDown } from "lucide-react";
      ...
      <div className="bg-white shadow-sm py-4 px-4 relative">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center space-x-3">
            ...
            <Search className="w-5 h-5 text-gray-600 cursor-pointer md:hidden" />
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center text-sm">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2 border border-white rounded px-2 py-1">
              <span>{zoom}%</span>
              <button onClick={increaseZoom} className="hover:text-orange-400 font-bold text-lg">+</button>
              <button onClick={decreaseZoom} className="hover:text-orange-400 font-bold text-lg">−</button>
            </div>
          </div>
        </div>
      </div>
